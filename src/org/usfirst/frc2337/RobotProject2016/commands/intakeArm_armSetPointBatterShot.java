...
public class intakeArm_armSetPointBatterShot extends Command {
	
	
	
	public intakeArm_armSetPointBatterShot() {
	...
	protected void initialize() {
		...
		Robot.intakeArmPID.setSetpoint(Robot.intakeArmPID.battershot);
		setTimeout(2);
