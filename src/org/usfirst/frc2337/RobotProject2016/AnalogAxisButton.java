...
public class AnalogAxisButton extends Button {
   ...
   */
  public AnalogAxisButton(GenericHID joystick, int axisNumber) {
      m_joystick = joystick;
   ...
   */
  public AnalogAxisButton(GenericHID joystick, int axisNumber, double threshold) {
  	  m_joystick = joystick;
      m_axisNumber = axisNumber;
      THRESHOLD = threshold;
  }
